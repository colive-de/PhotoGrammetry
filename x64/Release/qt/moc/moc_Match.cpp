...
template <> constexpr inline auto Match::qt_create_metaobjectdata<qt_meta_tag_ZN5MatchE_t>()
{
    ...
    QtMocHelpers::StringRefStorage qt_stringData {
        ...
        "on_run_clicked",
        "on_ExportPoints_stateChanged",
        "state",
        "on_txtStyle_clicked",
        "on_csvStyle_clicked",
        "on_SelectOutPath_clicked"
    };
    ...
    QtMocHelpers::UintData qt_methods {
        ...
        // Slot 'on_ExportPoints_stateChanged'
        QtMocHelpers::SlotData<void(int)>(5, 2, QMC::AccessPrivate, QMetaType::Void, {{
            { QMetaType::Int, 6 },
        }}),
        // Slot 'on_txtStyle_clicked'
        QtMocHelpers::SlotData<void()>(7, 2, QMC::AccessPrivate, QMetaType::Void),
        // Slot 'on_csvStyle_clicked'
        QtMocHelpers::SlotData<void()>(8, 2, QMC::AccessPrivate, QMetaType::Void),
        // Slot 'on_SelectOutPath_clicked'
...
void Match::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 3: _t->on_ExportPoints_stateChanged((*reinterpret_cast<std::add_pointer_t<int>>(_a[1]))); break;
        case 4: _t->on_txtStyle_clicked(); break;
        case 5: _t->on_csvStyle_clicked(); break;
        case 6: _t->on_SelectOutPath_clicked(); break;
        default: ;
        }
    }
}
